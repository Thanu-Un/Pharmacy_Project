...
export default function EditSupplier({ supplier, onBack, onSave }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`/api/operation/suppliers/${supplier.id}`, {
        method: 'PUT',
    ...
    <div className="p-6 max-w-3xl mx-auto">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Update details for {supplier?.company}</p>
        </div>
      </div>
