...
export default function AddPatient({ onBack, onSave }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorMsg || 'Failed to create patient');
            }
        ...
        <div className="p-6 max-w-3xl mx-auto">
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">Register a new patient profile</p>
                </div>
            </div>
