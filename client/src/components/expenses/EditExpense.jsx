...
export default function EditExpense({ expense, onBack, onSave }) {
  ...
  useEffect(() => {
    if (expense) {
      const d = expense.date ? expense.date.split('T')[0] : '';
      setFormData({
        date: d,
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="grid grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                className="w-full border border-slate-300 rounded-md p-2.5 focus:outline-none focus:ring-2 focus:ring-[#10b981] focus:border-transparent"
                required
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full border border-slate-300 rounded-md p-2.5 focus:outline-none focus:ring-2 focus:ring-[#10b981] focus:border-transparent resize-none"
            />
          </div>
